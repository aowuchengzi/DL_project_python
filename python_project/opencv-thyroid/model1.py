...
#%%
data_dir = r'E:\15339\my_keras\opencv-thyroid\mask_output'
...
#%%
model.load_weights('model1_weights_Epoch=500_mse=0.00012.h5')
#%%
...
#%%
model.save_weights('model1_weights_Epoch=600_mse=0.00008.h5')
#%%
model.save('model1_mse=0.00008.h5')
